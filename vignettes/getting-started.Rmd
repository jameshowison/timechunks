...
dept_df <- data.frame(
  dept     = c("Engineering", "Engineering", "Liberal Arts", "Liberal Arts"),
  semester = time_chunk(c("fa26", "sp27", "fa26", "sp27")),
  n        = c(1200L, 1100L, 800L, 750L)
)

# Long → wide: semester codes become column names
wide <- dept_df |>
...
# Wide → long: parse codes back to time_chunk
wide |>
